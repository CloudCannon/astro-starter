...
<SnippetsAstroImage image_path="/src/assets/images/blog-thumb-2.jpg" image_alt="A test image"/>

<SnippetsAlert background_color="#FF785A" alert_message="Test test test" color="#FEF9EF" icon="Bell"/>

<SnippetsAccordion heading="A test accordion" text="Some hidden text"/>

<SnippetsPopover button_text="A test popover" popover_text="Here's some popover text" id="a-unique-id"/>
