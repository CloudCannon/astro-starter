...
<SnippetsPopover button_text="A test popover" popover_text="You can do anything here - the only pre-requisite is that it makes you happy. And that's when it becomes fun - you don't have to spend your time thinking about what's happening - you just let it happen. You can create anything that makes you happy." id="a unique id"/>
...
<img src="/src/assets/images/blog-thumb-1.jpg" height="413" width="500" />
