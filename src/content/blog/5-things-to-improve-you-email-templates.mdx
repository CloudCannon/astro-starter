...
import Alert from '../../components/utility/markdown/Alert.astro';

import Tint from '../../components/utility/markdown/Tint.astro';

import Video from '../../components/utility/markdown/Video.astro';

import File from '../../components/utility/markdown/File.astro';

<Alert background_color="#FF0000" alert_message="This is an alert message" />
...
<Alert background_color="#e66bd1" alert_message="Another alert" />
