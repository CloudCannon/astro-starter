...
<Alert background_color="#FF0000" alert_message="This is an alert message" /> <Tint tint_color="#ff0000">This text should be red</Tint>

<alert background_color="#e86464" alert_message="Does this work?"/>

<tint tint_color="#005aee">This is some blue text</tint>
