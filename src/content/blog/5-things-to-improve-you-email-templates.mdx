...
import Tint from '../../components/markdown/Tint.astro';
...
<File src="/documents/test.pdf" file_name="an-example-file" link_message="Download the pdf"/>

<Tint tint_color="#d7ef4e">This is nested in a component folder</Tint>When you send an email campaign, you expect it to reach your readers, right? But what if the emails go straight to your subscribers' spam folders instead of their inboxes? To make sure your emails reach their recipients successfully, follow these email delivery tips.
